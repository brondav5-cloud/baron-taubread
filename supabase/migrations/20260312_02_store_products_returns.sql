-- =============================================
-- Add monthly_returns to store_products table
-- Update RPC to save product-level returns
-- =============================================

-- 1. Add column (safe if already exists)
ALTER TABLE public.store_products
  ADD COLUMN IF NOT EXISTS monthly_returns JSONB NOT NULL DEFAULT '{}';

-- 2. Replace RPC to include monthly_returns
