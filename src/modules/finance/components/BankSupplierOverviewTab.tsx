...
export function BankSupplierOverviewTab({
  ...
  const kpis = [
    {
      ...
      sub: `${currentYearSummary?.count ?? 0} תשלומים`,
      color: "text-gray-900",
    },
    {
      label: "ממוצע חודשי",
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-4">
          ...
          <div className="flex items-end gap-3 h-20">
            {yearSummary.map(({ year: yr, total }) => {
              const maxVal = Math.max(...yearSummary.map((y) => y.total), 1);
                ...
                >
                  ...
                  <span
                    className={clsx(
                      ...
                      yr === selectedYear ? "text-blue-800" : "text-gray-400",
                    )}
                  >
                    {yr}
                  </span>
