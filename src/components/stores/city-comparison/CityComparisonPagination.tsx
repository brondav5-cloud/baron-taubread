...
interface CityComparisonPaginationProps {
  currentPage: number;
  totalPages: number;
  pageSize: number;
  totalItems: number;
...
export function CityComparisonPagination({
  currentPage,
  totalPages,
  pageSize,
  totalItems,
    ...
    <div className="flex items-center justify-between px-4 py-3 bg-gray-50 border-t">
      <div className="flex items-center gap-4">
        <span className="text-sm text-gray-600">
          מציג {displayStart}-{displayEnd} מתוך {totalItems}
        </span>
