    ...
    <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-lg border-b border-gray-200 pt-[env(safe-area-inset-top)]">
      <div className="flex items-center justify-between h-16 px-4 lg:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Company Picker - when user has multiple companies */}
          <CompanyPicker />
          {/* Global Search - גלילה אופקית במובייל */}
        ...
        <div className="flex items-center gap-2">
          {/* Add Visit Button - אייקון בלבד במובייל */}
          <button
            onClick={handleAddVisit}
            className="flex items-center gap-2 px-3 py-2 sm:px-4 bg-primary-500 text-white rounded-xl text-sm font-medium hover:bg-primary-600 transition-colors"
            title="הוסף ביקור"
          >
            <Plus className="w-4 h-4 shrink-0" />
            <span className="hidden sm:inline">הוסף ביקור</span>
          </button>
          ...
          <div className="relative">
            ...
            {showNotifications && (
              <>
                ...
                />
                <div className="absolute left-0 mt-2 w-80 bg-white rounded-xl shadow-elevated border border-gray-100 z-20 animate-scale-in">
          ...
          <div className="relative">
            ...
            {showUserMenu && (
              <>
                ...
                />
                <div className="absolute left-0 mt-2 w-56 bg-white rounded-xl shadow-elevated border border-gray-100 z-20 animate-scale-in">
