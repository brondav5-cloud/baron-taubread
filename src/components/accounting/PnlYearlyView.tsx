...
import {
  ...
  fmt, fmtFull, pctOfRev, getCellColor,
  CellTooltip, SECTION_STYLES, ViewModeToggle,
} from "./pnlHelpers";
import { exportPnlToExcel } from "./pnlExcelExport";
...
function PnlYearlyView({
  ...
  const handleExport = useCallback(() => {
    void exportPnlToExcel(yearlyPnl, year, groupsBySection);
...
export default React.memo(PnlYearlyView);
